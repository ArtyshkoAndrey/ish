                            ...
                            <div class="box-body">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title" name="name" placeholder="Title" value="{{$course->name}}">
                                    </div>

                                    <div class="form-group">
                                        <label for="subtitle">Подзаголовок</label>
                                        <input type="text" class="form-control" id="subtitle" name="content" placeholder="Sub Title" value="{{$course->content}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="subtitle">Иконка</label>
                                        <input type="text" class="form-control" id="meta_keywords" name="icon" placeholder="ico" value="{{$course->icon}}">
                                    </div>
